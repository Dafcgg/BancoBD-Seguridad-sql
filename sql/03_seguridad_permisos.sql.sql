...
GRANT SELECT (id_cuenta, titular, saldo), UPDATE (saldo) ON BancoDB.cuentas TO 'cajero_app'@'localhost';
...
REVOKE UPDATE ON BancoDB.cuentas FROM 'cajero_app'@'localhost';
FLUSH PRIVILEGES;
